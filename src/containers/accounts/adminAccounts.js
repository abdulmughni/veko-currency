    ...
    render() {
        ...
        const columns = [
            ...
            },
            {
                ...
                dataIndex: 'veko',
                key: 'veko',
                render: (text, record) => <Icon onClick={e => this.buyOrder(record)} type="area-chart"/>
            }
        ];
                ...
                <LayoutContent>
                    ...
                    <div>
                        <Modal visible={this.state.orderWindowShow} footer={null}
                               title={`${this.state.orderType} Order`} closable={false}
                               destroyOnClose={true}
                        >
                            <OrderWindow
                    ...
                    <Table dataSource={accounts} size="small" columns={columns} scroll={{x: 600}}
...
}), {findUser, localPatch, ...vekoActions})(Accounts)
